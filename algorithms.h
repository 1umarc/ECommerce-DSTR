...
private:
    ...
    Both* merge(Both* first, Both* second)
    {
        if (first == nullptr)
        {
            return second;
    ...
    Frequency* merge(Frequency* first, Frequency* second)
    {
        if (first == nullptr)
        {
            return second;
...
public:    
    ...
    - Space Complexity: O(n)
    */
   void mergeSort(BothBucket& bucket)
   {
       mergeSort(bucket.data, 0, bucket.size - 1);
   }
   void mergeSort(FrequencyBucket& bucket)
   {
       mergeSort(bucket.data, 0, bucket.size - 1);
   }

private:
    void mergeSort(Both* arr, int left, int right)
    {
        if (left >= right)
        {
            return;
   ...
   void mergeSort(Frequency* arr, int left, int right)
   {
       if (left >= right)
       {
           return;
   ...
   void merge(Both* arr, int left, int mid, int right)
   {
...
public:
    ...
    - Space Complexity: O(1)
    */
    void insertionSort(BothBucket& bucket)
    {
        int n = bucket.size;
...
public:
    ...
    - Space Complexity: O(1)
    */
    void heapSort(BothBucket& bucket) 
    {
    ...
    void heapSort(FrequencyBucket& bucket) 
    {
...
private:
    void heapify(BothBucket& bucket, int size, int i) 
    {
        int largest = i;
        int left = 2 * i + 1;
        int right = 2 * i + 2;
    ...
    void heapify(FrequencyBucket& bucket, int size, int i) 
    {
        int largest = i;
        int left = 2 * i + 1;
        int right = 2 * i + 2;
...
public:
    ...
    */    
    void quickSort(BothBucket& bucket)
    {
        quickSort(bucket.data, 0, bucket.size - 1);
    }
    void quickSort(FrequencyBucket& bucket)
    {
        quickSort(bucket.data, 0, bucket.size - 1);
    }

private:
    void quickSort(Both* arr, int low, int high)
    {
        if (low < high)
        {
    ...
    void quickSort(Frequency* arr, int low, int high)
    {
        if (low < high)
        {
            // Partition the array and get pivot index
    ...
    int partition(Both* arr, int low, int high)
    {
    ...
    int partition(Frequency* arr, int low, int high)
    {
        // Choose rightmost element as pivot
...
public:
    ...
    - Space Complexity: O(1)
    */
    Transaction* sequentialSearch(int* sizePtr, Transaction* head, const string& field1, const string& text1, const string& field2, const string& text2)
    {
        int size = 0;
    ...
    Review* sequentialSearch(int* sizePtr, Review* head, const string& field1, const string& text1)
    {
        int size = 0;
        Review* current = head;
...
public:
    ...
    - Space Complexity: O(1)
    */
    Transaction* linearSearch(int* sizePtr, Transaction* head, const string& field1, const string& text1, const string& field2, const string& text2)
    {
        int count = 0;
        Transaction* current = head;
    ...
    Review* linearSearch(int* sizePtr, Review* head, const string& field1, const string& text1)
    {
        int count = 0;
        Review* current = head;
...
public:
    ...
    - Space Complexity: O(1)
    */
    Transaction* recursiveSearch(int* sizePtr, Transaction* head, const string& field1, const string& text1, const string& field2, const string& text2)
    {
    ...
    Review* recursiveSearch(int* sizePtr, Review* head, const string& field1, const string& text1)
    { 
        // Base case: end of list
        if (head == nullptr)
        {
...
public:
    ...
    - Space Complexity: O(1)
    */
    Transaction* sentinelSearch(int* sizePtr, Transaction* head, const string& field1, const string& value1, const string& field2, const string& value2) 
    {
        int count = 0;
        Transaction* current = head;
    ...
    Review* sentinelSearch(int* sizePtr, Review* head, const string& field1, const string& value1) 
    {
        int count = 0;
        Review* current = head;
        Review* prev = nullptr; 
...
public:
    ...
    - Space Complexity: O(1)
    */
    int sequentialSearch(TransactionBucket& bucket, const string& field1, const string& text1, const string& field2, const string& text2)
    {
        int size = 0;
    ...
    int sequentialSearch(ReviewBucket& bucket, const string& field1, const string& text1)
    {
        int size = 0;
        int readInd = 0;  // Index for reading elements
        int writeInd = 0; // Index for writing matching elements
...
public:
    ...
    */
    int linearSearch(TransactionBucket& bucket, const string& field1, const string& text1, const string& field2, const string& text2)
    {
        int count = 0;
    ...
    int linearSearch(ReviewBucket& bucket, const string& field1, const string& text1)
    {
        int count = 0;
...
public:
    ...
    - Space Complexity: O(1)
    */
    int binarySearch(TransactionBucket& bucket, const string& field1, const string& value1, const string& field2, const string& value2) 
    {
        int count = 0;
    ...
    int binarySearch(ReviewBucket& bucket, const string& field1, const string& value1) 
    {
        int count = 0;
...
public:
    ...
    - Space Complexity: O(1)
    */
    int jumpSearch(TransactionBucket& bucket, const string& field1, const string& text1, const string& field2, const string& text2)
    {
        int size = 0;
        int readInd = 0;  // Index for reading elements
        int writeInd = 0; // Index for writing matching elements
    ...
    int jumpSearch(ReviewBucket& bucket, const string& field1, const string& text1)
    {
        int size = 0;
        int readInd = 0;  // Index for reading elements
        int writeInd = 0; // Index for writing matching elements
